          ...
          <div className="flex w-full items-center justify-between px-5">
            ...
            <div>
              <a href="#" className="sb-logo">
                ...
                <span className="sb-heart heart-1">♡</span>
                <span className="sb-heart heart-2">♡</span>

              
                <span className="sb-sparkle sparkle-1">✦</span>
                <span className="sb-sparkle sparkle-2">✧</span>
                <span className="sb-sparkle sparkle-3">✦</span>
                <span className="sb-sparkle sparkle-4">✧</span>
...
const Navbar = ({ darkMode, setDarkMode }) => {
  ...
  const handleLogoClick = (e) => {
    ...
    setTimeout(() => {
      window.dispatchEvent(new Event("heroReplay"))
    }, 500)
          ...
          <div className="flex w-full items-center justify-between px-5">
            ...
            <div>
              ...
              >
                ...
                <span className="sb-heart heart-1">
                  ♡
                </span>

                <span className="sb-heart heart-2">
                  ♥
                </span>

                <span className="sb-sparkle sparkle-1">
                  ✦
                </span>

                <span className="sb-sparkle sparkle-2">
                  ✧
                </span>

                <span className="sb-sparkle sparkle-3">
                  ✦
                </span>

                <span className="sb-sparkle sparkle-4">
                  ·
                </span>
              </a>
            </div>

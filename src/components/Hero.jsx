...
const Hero = () => {
  ...
  useEffect(() => {
    ...
    window.addEventListener("heroReplay", replayHero)

    return () => {
      window.removeEventListener("heroReplay", replayHero)
...
const Hero = () => {
  ...
  return (
    <section
      ref={heroRef}
      id="home"
      className="hero-section flex min-h-screen flex-col items-center justify-center gap-4 lg:gap-6"
    >
      {/* HERO TITLE */}
